...
export { ClientOptions } from 'vra_iaas';
...
async function getInstructions() {
  ...
  const response = await fetch(
    readEnv('CODE_MODE_INSTRUCTIONS_URL') ?? 'https://api.stainless.com/api/ai/instructions/vra_iaas',
    {
      method: 'GET',
  ...
  if (!response.ok) {
    ...
    instructions = `
      This is the vra_iaas MCP server. You will use Code Mode to help the user perform
